...
<img src="img/cka_minibatch.png" alt="cka_minibatch" style="zoom: 50%;" />

<img src="img/hsic.png" alt="hsic" style="zoom: 50%;" />

## Example

A simple example comparing layer outputs of resnet18 can be found in `example.py`.

<img src="img/r18_cka.png" alt="r18_cka" style="zoom:50%;" />
